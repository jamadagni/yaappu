...
from PyQt5.QtCore import Qt, QSettings, QSize, QByteArray
...
def ஆய்வுகளை_உருவாக்கு(உள்ளீடு):
    ...
    global அலகிடப்பட்ட_பாக்கள், அடி_முழு_ஆய்வு, அடி_சுருக்க_ஆய்வு, வரி_வாரியான_ஆய்வு
    ...
    for பா in அலகிடப்பட்ட_பாக்கள்:
        if பா:
            for அடி in பா:
                வரி_வாரியான_ஆய்வு.append(அடி)
        else:  # தமிழ் இல்லாத வரி
            வரி_வாரியான_ஆய்வு.append(பா)
...
class அசை_உறுப்பு_காட்டுவான்(QSyntaxHighlighter):
    ...
    def highlightBlock(தான், உள்ளீட்டு_வரி):
        ...
        இவ்வரி_எண் = தான்.previousBlockState() + 1
        தான்.setCurrentBlockState(இவ்வரி_எண்)
        try:
            அடி = வரி_வாரியான_ஆய்வு[இவ்வரி_எண்]
        except IndexError:  # QSyntaxHighlighter இறுதி வரிக்கு அடுத்த வரிக்கு உறுப்பு காட்ட முயலும்
            return
        if not அடி:  # தமிழ் அல்லாத வரியாக இருக்கும், உறுப்பு காட்ட தேவை இல்லை
            return
        for சீர்_எண், சீர் in enumerate(அடி):
            if சீர்_எண் > 15:
                தான்.setFormat(சீர்.தொடக்கம், சீர்.முடிவு - சீர்.தொடக்கம், வண்ணம்_தவறு)
                continue
...
class அடி_ஆய்வு_உறுப்பு_காட்டுவான்(QSyntaxHighlighter):
...
class பா_மொத்த_ஆய்வு_உறுப்பு_காட்டுவான்(QSyntaxHighlighter):
...
class பாவை_ஜன்னல்(QWidget):
    ...
    def __init__(தான்):
        ...
        தான்.அசை_உறுப்பு_காட்டுவான் = அசை_உறுப்பு_காட்டுவான்(பெ.document(), தான்)
        ...
        பெ.setReadOnly(True)
        பெ.setLineWrapMode(QPlainTextEdit.NoWrap)
        தான்.அடி_ஆய்வு_உறுப்பு_காட்டுவான் = அடி_ஆய்வு_உறுப்பு_காட்டுவான்(பெ.document())
        ...
        பெ.setReadOnly(True)
        தான்.பா_மொத்த_ஆய்வு_உறுப்பு_காட்டுவான் = பா_மொத்த_ஆய்வு_உறுப்பு_காட்டுவான்(பெ.document())
        ...
        for அ in தான்.தளைகள்_தேர்வு_அழுத்துவான்கள்:
            ...
            அ.toggled.connect(lambda: தான்.அடி_ஆய்வு_உறுப்பு_காட்டுவான்.rehighlight())
            அமை.addWidget(அ)
    ...
    def வண்ணத்திட்டம்_அமை(தான், பெயர்):
        ...
        தான்.அசை_உறுப்பு_காட்டுவான்.rehighlight()
        தான்.அடி_ஆய்வு_உறுப்பு_காட்டுவான்.rehighlight()
